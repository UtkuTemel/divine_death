...
function castSpell() {
    ...
    player.castingTimer = 300; // ms to show hand
    ...
    if (spell.type === "PROJECTILE") {
        ...
        projectiles.push({
            ...
            size: spell.size,
            active: true,
            sprite: spellImages.fireball, // Use cached image
            onHitEffect: spell.onHitEffect,
            source: "PLAYER" // To prevent hitting yourself
        });
    }
}
